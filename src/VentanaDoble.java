 ...
 * @author Angel
 */
public class VentanaDoble extends javax.swing.JFrame {

    public static VentanaDoble getInstance(){
        if (instance == null)
            instance = new VentanaDoble();
        return instance;
    }

    private VentanaDoble() {
        initComponents();
        ld = new ListaDoble();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAgregarActionPerformed
        try {
            ...
            ld.agregar(Integer.parseInt(txtAgregar.getText()));
            txtAgregar.setText("");
        } catch (Exception e) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditarActionPerformed
        try {
            ...
            if (!ld.editar(Integer.parseInt(txtBuscar.getText()),Integer.parseInt(txtRemplazar.getText()))) {
                throw new Exception("No se encontró el nodo");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaDoble().setVisible(true);
            }
        });
    }

    private ListaDoble ld;
    private static VentanaDoble instance;
